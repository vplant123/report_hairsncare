import {
  ...
  export const Order_Email = ({ order, status }) => (
      ...
      <Body style={main}>
        ...
        <Container style={container}>
          <Section>
            <Row>
              <Column>
                <Text style={heading}>Your Order Placed</Text>
              </Column>
          ...
          <Section>
            ...
            {order?.products?.map(ele => (
              <Row>
                ...
                <Column style={productPriceWrapper} align="right">
                  <Text style={productPrice}>Rs.{(parseFloat(ele?.item?.price) - parseFloat(ele?.item?.discount || 0)) * (ele?.quantity || 1)}</Text>
                </Column>
              </Row>
            ))}
          </Section>
              ...
              <Column style={{}}>
                <Row>
                  ...
                  <Text style={NormalText}>
                    {"HairsnCares.com, 101, Kane Plaza, Above Union Bank, Near Evershine Mall, Mindspace, Malad West, Mumbai, Maharashtra, 400064"}
                  </Text>
                </Row>
              </Column>
            </Row>
