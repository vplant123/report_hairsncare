                    ...
                    {Object.keys(prescriptionM || {}).map((it, ind) => {
                      return (
                        <div className={`d-flex flex-column ${ind + 1 == p || ind + 1 == (10 + p) || ind + 1 == (20 + p) ? "page-break-1" : ""}`}>
                          ...
                          <div style={{ margin: "0 0 6px 25px", ontSize: "13px", fontWeight: "600" }}>{`${prescriptionM[it].dosage
                            } ${prescriptionM[it].route} ${prescriptionM[it].frequency}  ${prescriptionM[it].route === "Oral" ? prescriptionM[it].when : ""
                            } ${prescriptionM[it].duration} ${prescriptionM[it].instructions
                            }`}</div>
                        </div>
                      );
                    })}
